  ...
  return new PublicClientApplication({
    auth: {
      ...
      //clientId: '3fba556e-5d4a-48e3-8e1a-fd57c12cb82e', // PPE testing environment
       authority: 'https://login.microsoftonline.com/6e93a626-8aca-4dc1-9191-ce291b4b75a1', // Prod environment. Descomente para usar.
...
export function MSALInterceptorConfigFactory(): MsalInterceptorConfiguration {
  const protectedResourceMap = new Map<string, Array<string>>();
   protectedResourceMap.set('https://login.microsoftonline.com/6e93a626-8aca-4dc1-9191-ce291b4b75a1', ['user.read']); // Prod environment. Descomente para usar.
